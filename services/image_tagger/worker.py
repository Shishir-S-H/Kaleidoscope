...
CONSUMER_GROUP = "image-tagger-ml-group"
...
def handle_message(message_id: str, data: dict, publisher: RedisStreamPublisher):
    ...
    try:
        ...
        result = provider.tag(image_bytes)
...
def main():
    LOGGER.info("Image Tagger Worker starting...")
    ...
    try:
        ...
        start_health_server(
            service_name="image-tagger",
            health_fn=lambda: check_health(get_metrics(), "image-tagger"),
